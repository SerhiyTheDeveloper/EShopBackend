...
namespace MINT.EShop.API.Controllers
{
    ...
    namespace MINT.EShop.API.Controllers
    {
        ...
        public class UsersController(IUserService userService) : ControllerBase
        {
            ...
            /// <returns>Повертає об'єкт UserResponse у форматі APIResponse.</returns>
            /// <response code="200">Користувача іспішно знайдено.</response>
            ...
            /// <summary>
            /// Оновити інформацію про користувача за його унікальним ідентифікатором (ID).
            /// </summary>
            /// <param name="id">Унікальний ідентифікатор користувача (GUID).</param>
            ...
            /// </summary>
            /// <param name="id">Унікальний ідентифікатор користувача (GUID).</param>
            /// <returns>Повертає ID видаленого користувача у форматі APIResponse.</returns>
